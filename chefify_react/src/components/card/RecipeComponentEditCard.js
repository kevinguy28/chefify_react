...
import "../../styling/css/recipeComponentEditCard.css";


const RecipeComponentEditCard = ({component, index, handleChange, handleDelete, handleSubmit}) => {
  return (
...
export default RecipeComponentEditCard
